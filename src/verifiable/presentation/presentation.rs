        ...
        let vp_str = r###"{
            ...
            "verifiableCredential": {
              ...
              "proof": {
                ...
                "created": "2023-04-18T06:26:31.355301Z",
            ...
            "proof": {
              "type": "Ed25519Signature2018",
              "created": "2023-04-18T06:26:31.355864Z",
              "proofPurpose": "assertionMethod",
              "proofValue": "z3ccPeXQKuP3QsG1eFCmTV2V8uDmkZNwMqc5ipYHemH4txCfPqL5TbJpWqqbYgvNhXAppJBEAzz2BcNRzNumPgVjQ",
              "verificationMethod": "did:example:foo#keys-1"
            },
            "holder": "did:example:foo"
          }"###;

        let mut vp: Presentation = Presentation::from_json(vp_str).unwrap();
